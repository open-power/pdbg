...
/**
 * @brief Get the PIB pdbg target for the matching oddyssey ocmb chip target
...
/**
 * @brief Get the fsi pdbg target for the matching oddyssey ocmb chip target
 ...
 * switching the backend in the running process. It clears/releases the 
